...
export default class Player {
  constructor({ app }) {
    ...
    app.stage.addChild(this.player); //додаємо квадрат на сцену
  }
  ...
  update() {
    ...
    let angle =
      ...
      Math.PI / 2; //коригуємо кут, щоб квадрат обертався до курсора
    this.player.rotation = angle; //обертаємо квадрат до курсора
  }
}
